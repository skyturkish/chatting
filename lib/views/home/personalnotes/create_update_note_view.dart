...
import 'package:groupnotes/utilities/dialogs/cannot_share_empty_note_dialog.dart';
import 'package:groupnotes/utilities/generics/get_arguments.dart';
...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView> {
  ...
  Future<CloudNote> createOrGetExistingNote(BuildContext context) async {
    ...
    if (widgetNote != null) {
      // adam '+' ya mı basmış yoksa olan bir nota mı? geriye dönmüş bize
      _note = widgetNote;
      _textController.text = widgetNote.text; // text yerine olan notun notunu geçiyoruz
      return widgetNote;
    }
